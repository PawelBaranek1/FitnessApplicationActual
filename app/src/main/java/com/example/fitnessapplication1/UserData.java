...
public class UserData extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Spinner spinner = findViewById(R.id.spnrAgeRange);
        ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.ageRange, android.R.layout.simple_spinner_item);
